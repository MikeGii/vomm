...
export const CheatDetector: React.FC = () => {
    ...
    // Define severity keys type for type safety
                            ...
                            <div className="scan-results">
                                ...
                                <div className="severity-breakdown">
                                    ...
                                    <div className="severity-grid">
                                        {/* Fixed: Proper typing for severity entries */}
                                        {(Object.entries(results.severityCounts) as Array<[SeverityKey, number]>).map(([severity, count]) => (
                                            <div
                                                key={severity}
                                ...
                                {results.topOffenders.length > 0 && (
                                    <div className="top-offenders">
                                        ...
                                        <div className="offenders-list">
                                            {/* Fixed: Proper typing for offender parameter */}
                                            {results.topOffenders.map((offender: { userId: string; username: string; violationCount: number; maxSeverity: string; }, index: number) => (
                                ...
                                {results.suspiciousActivities.length > 0 ? (
                                            ...
                                            {results.suspiciousActivities.slice(0, 10).map((activity, index) => (
                                                <div key={index} className="activity-card">
                                                    ...
                                                    <div className="activity-details">
                                                        ...
                                                        <div className="detail-row">
                                                            <span className="detail-label">Started in future:</span>
                                    ...
                                    <div className="no-suspicious-activity">
                                        ✅ Kahtlast tegevust ei tuvastatud!
                                    </div>
                                )}
                            </div>
                        )}
